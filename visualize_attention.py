...
# 导入你训练脚本里的依赖
from train_ultimate import PaperModel, MolGraphBuilder, encode_kmer_sequence
...
def visualize_drug_gene_attention(smiles, gene_seq, model_path, device_str='cuda:0'):
    ...
    out_file = f"attn_heatmap_{safe_smiles}.png"
...
if __name__ == "__main__":
    ...
    # 你的最优模型路径
    model_checkpoint = "results_paper/MCF7/model_orthoTrue_clTrue_hybrid.pt"
    
    if os.path.exists(model_checkpoint):
        visualize_drug_gene_attention(test_smiles, test_gene, model_checkpoint)
    else:
